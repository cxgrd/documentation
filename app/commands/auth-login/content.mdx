...
Authentication commands for Pro, Team, and Enterprise users. This command is required to access paid features
...
✓ Opening browser for GitHub sign-in...
   Session: d83*****...
   If the browser does not open: https://www.cxgrd.com/auth/cli?session=d8349e...
...
See [`cxgrd check --ci`](/commands/check) for the full CI setup guide.
