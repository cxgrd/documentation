...
See [`cxgrd input`](/commands/input)
...
This opens GitHub OAuth in your browser. After signing in, visit [cxgrd.com/pricing](https://www.cxgrd.com/pricing) to upgrade.
...
5. Add the cxgrd workflow file to your repo (see [`cxgrd check --ci`](/commands/check))
